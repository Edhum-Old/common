...
public interface CommandDispatcher {
    ...
    void dispatchExecution(CommandTree tree, CommandSender sender, String[] args) throws ArgumentException, InvalidRequirementException, InvalidPermissionException, InvalidSyntaxException;
