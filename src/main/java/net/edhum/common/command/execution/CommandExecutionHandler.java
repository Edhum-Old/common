...
public interface CommandExecutionHandler {
    ...
    void handleExecution(CommandNode node, CommandSender sender, StringBuffer buffer) throws ArgumentException, InvalidRequirementException, InvalidPermissionException, InvalidSyntaxException;
}
